...
// import { pendingRequest } from "../Collections/friendrequest.collection"
...
const PendingFriend = () => {
  ...
  // const[dostData,setDostData] = useState([])
  ...
  return (
     <div className="cards-container">
            ...
            .map(({ friendName, friendProfilePic, friendId ,id , type , userId }) => {
                            return(
                              <div key={friendId} >
                                <Card name={friendName} img={friendProfilePic} state="pendingFriends" friendId={friendId} userId={userId} requestId={id} t={type} />
                              </div>
                            );
                          })
                          )
