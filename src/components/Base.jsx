...
import {Linkedln_logo_full , collabrativeArcticle ,findJobs , postJob ,software_tools} from '../constants/constant'
import './Base.css';
import Icons from "./Icons";
import {PaperClipOutlined , UsergroupDeleteOutlined , DollarOutlined , QqOutlined , TwitterOutlined , MailFilled} from '@ant-design/icons'
  ...
  return (
    <div className="base_page">
        ...
        <div className="bottomBar">
          ...
          <p className="disclaimer">By clicking Continue to join or sign in, you agree to <span> LinkedIn’s User Agreement, Privacy Policy</span>, and <span> Cookie Policy.</span> </p>

          <p className="new_user_text">New to LinkedIn? <span>Join now</span> </p>
        ...
        {/* second screen 2 */}
        <Screen2 arr={collabrativeArcticle}
